 ...
 * integrated security
 */
final class ConnectionConfigurationAlgebra {
    ...
    static Connection getJdbcConnection() {
        ConnectionConfigurationAlgebra config = null;
        try {
            File configFile = new File("src/main/resources/databaseConnection.json");
            if (configFile.exists()) {
                String configFileAsString = readFile(configFile);
                config = JSON_SERIALIZER.fromJson(configFileAsString, ConnectionConfigurationAlgebra.class);
    ...
    private static ConnectionConfigurationAlgebra createConfig() {
        ConnectionConfigurationAlgebra config = new ConnectionConfigurationAlgebra();
